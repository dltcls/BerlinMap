...
zweitstimme %>% filter(Wahlkreis == "Charlottenburg-Wilmersdorf") -> charlottenburgWilmersdorf
...
cols_light <- c("#afc7ea", "#3b3939", "#ffeda3", "#d4efaf", "#e293ba", "#cccccc", "#eb807f", "#B7B7B7")
...
table <- mutate(charlottenburgWilmersdorf, order = 10000 - Jahr)
